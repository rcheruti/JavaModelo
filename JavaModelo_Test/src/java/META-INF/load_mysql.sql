...
insert into seg_credencial( bloqueado, erros, login, renovarSenha, usuario_id, senha ) values( 0, 0, 'rafael', 0, 1, '¦\0>7???Nl¡-"ßwa,	qA?LÞa»}*,?ªß6Õ<æk?¶*Çîÿ??Å}Ù <?~VÜ?' );
insert into seg_credencial( bloqueado, erros, login, renovarSenha, usuario_id, senha ) values( 0, 0, 'alguem', 0, 2, '¦\0>7???Nl¡-"ßwa,	qA?LÞa»}*,?ªß6Õ<æk?¶*Çîÿ??Å}Ù <?~VÜ?' );
insert into seg_credencial( bloqueado, erros, login, renovarSenha, usuario_id, senha ) values( 0, 0, 'rosana', 0, 3, '¦\0>7???Nl¡-"ßwa,	qA?LÞa»}*,?ªß6Õ<æk?¶*Çîÿ??Å}Ù <?~VÜ?' );
insert into seg_credencial( bloqueado, erros, login, renovarSenha, usuario_id, senha ) values( 1, 0, 'joao',   0, 4, '¦\0>7???Nl¡-"ßwa,	qA?LÞa»}*,?ªß6Õ<æk?¶*Çîÿ??Å}Ù <?~VÜ?' );
