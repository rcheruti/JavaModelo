...
public class PersistenciaConfig {
  ...
  public static void init() throws IOException{
    ...
    if( url != null ){
      ...
      Map<String,String> mapConfigs = new HashMap<>(16);
      Iterator<String> itN = json.fieldNames();
      while( itN.hasNext() ){
        String s = itN.next();
        if( "hibernate".equals(s) || "entidades".equals(s) ) continue;
        mapConfigs.put(s, json.get(s).asText());
      }
      Configuracoes.load(mapConfigs);
